...
public class ValidarMultiNegativoTEST {
    ...
    public  void PruebaTestNG() {
        waiter(2000);
        WebElement Tecla_negativo = driver.findElement(By.id("subs"));
        Tecla_negativo.click();
        ...
        {
            System.out.println("La division de negativos y positivos fue exitosa");
            waiter(6000);
        }
        else{
            System.out.println("Hubo un error realizando La division de negativos y positivos");
        }
    }
